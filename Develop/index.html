...
<body>
    ...
    <!--welcome image-->
    <section class="hero" title="homepage-picture"></section>
    ...
    <section class="content">
        ...
        <article class="online-reputation-management">
            <img src="./assets/images/online-reputation-management.jpg" alt="online-management" class="float-right" />
    ...
    <div class="benefits">
        ...
        <section class="benefit-brand">
            ...
            <img src="./assets/images/brand-awareness.png" alt="brand-awerness"/>
            <p>
